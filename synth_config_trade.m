...
%}
%clear; clc; close all;
function [OUTPUT] = synth_config_trade(AR_in, TR_in, tc_in)
%% ========================================================================
% Configuration and mission iteration:
config_iter = sprintf('AR = %g, TR = %g',AR_in, TR_in); % for saving figures

AR_unswept = AR_in;                       % Unswept aspect ratio
TR = TR_in;                               % Wing taper ratio
tcmax = tc_in;                            % T/c max; variable to iterate
...
fprintf('\n\n ===================================================================================== \n');
fprintf('\n Vertical tail size estimate: (C_VT = %g)', C_VT);
