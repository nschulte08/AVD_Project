function [weights, weight_fractions] = AVD_Weight_Buildup( W_to, num_pass, num_crew, V_cr, M_cr, range, SFC, LD_cr )
...
if M_cr > 1
    WF_climb = 0.991 - 0.007*M_cr - 0.01*(M_cr)^2;  % Weight fraction if climbing from Mach .1 to Mach 1.4
...
% Fuel weight to takeoff weight ratio from the calculated weight ratios
